...
class BuildingsControllerTest < ActionController::TestCase
  ...
  test "should create building" do
    assert_difference('Building.count') do
      post :create, building: { description: @building.description, developer_id: @building.developer_id, name: @building.name }
    end
  ...
  test "should update building" do
    patch :update, id: @building, building: { description: @building.description, developer_id: @building.developer_id, name: @building.name }
    assert_redirected_to building_path(assigns(:building))
  end
