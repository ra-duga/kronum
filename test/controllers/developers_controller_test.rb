...
class DevelopersControllerTest < ActionController::TestCase
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post :create, developer: { description: @developer.description, logo_url: @developer.logo_url, name: @developer.name }
    end
  ...
  test "should update developer" do
    patch :update, id: @developer, developer: { description: @developer.description, logo_url: @developer.logo_url, name: @developer.name }
    assert_redirected_to developer_path(assigns(:developer))
  end
